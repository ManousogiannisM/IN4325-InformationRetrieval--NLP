...
#necessary in order to make standford parser to work
os.environ['STANFORD_MODELS'] = 'C:\\Users\\Georgia\\PycharmProjects\\Dokimi\\jars\\stanford-parser-3.9.1-models.jar'
os.environ['STANFORD_PARSER'] = 'C:\\Users\\Georgia\\PycharmProjects\\Dokimi\\jars\\stanford-parser.jar'


######## Standford tagger  ########################
model = 'C:\\Users\\Georgia\\PycharmProjects\\Dokimi\\jars\\english-bidirectional-distsim.tagger'
jar ='C:\\Users\\Georgia\\PycharmProjects\\Dokimi\\jars\\stanford-postagger.jar'
pos_tagger = StanfordPOSTagger(model, jar, encoding='utf8')

########## stanford depedency parser ############
dep_parser=StanfordDependencyParser(model_path="C:\\Users\\Georgia\\PycharmProjects\\Dokimi\\jars\\englishPCFG.ser.gz")
